...
export interface NftAuctionV2Interface extends Interface {
  ...
  encodeFunctionData(functionFragment: "testHello", values?: undefined): string;
  encodeFunctionData(
  ...
  decodeFunctionResult(functionFragment: "testHello", data: BytesLike): Result;
  decodeFunctionResult(
    functionFragment: "upgradeToAndCall",
    data: BytesLike
  ): Result;
...
export interface NftAuctionV2 extends BaseContract {
  ...
  testHello: TypedContractMethod<[], [string], "view">;
